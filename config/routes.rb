...
Rails.application.routes.draw do
  ...
  namespace :settings do
    ...
    resources :installed_qualifiers, controller: 'savyasachi/installed_qualifiers', only: [:index, :show, :edit, :update, :destroy]
  ...
  namespace :api do
    ...
    namespace :v1 do
      ...
      resources :filter_conditions, controller: 'savyasachi/filter_conditions'
      resources :action_types, controller: 'savyasachi/action_types'
