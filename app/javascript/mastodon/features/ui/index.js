    ...
    return (
      <ColumnsAreaContainer ref={this.setRef} singleColumn={mobile}>
        <WrappedSwitch>
          ...
          <WrappedRoute path='/timelines/folder/:id' component={FolderTimeline} content={children} componentParams={{ shouldUpdateScroll: this.shouldUpdateScroll }} />
          ...
          <WrappedRoute path='/folders' component={Folders} content={children} componentParams={{ shouldUpdateScroll: this.shouldUpdateScroll }} />
